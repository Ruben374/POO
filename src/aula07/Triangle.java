...
public class Triangle extends Figure {
    ...
    public boolean equals(Object obj) {
        ...
        return super.equals(obj) && Double.compare(outroTriangulo.lado1, lado1) == 0 &&
    ...
    public Triangle(double lado1, double lado2, double lado3, String color) {
    ...
    public static void main(String[] args) {
        Triangle novo = new Triangle(1, 1, 3, "red");
